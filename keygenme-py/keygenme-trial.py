...
def check_key(key, username_trial):
    #key is string data from user input, and username_trial is binary data
    ...
    if len(key) != len(key_full_template_trial):
        ...
        #hashlib.sha256(username_trial).hexdigest()=281f75c0145b05e6ccbeecc66a61614d8c974c1a49356c118fcbab4735862fea
